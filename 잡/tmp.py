...
import socket # private ip 
import threading # many connection camera data and receive
import requests 

# Get local ip address 
# LOCAL_IP = 163.180.116.47

# get ip by python 
local_ip_address = socket.gethostbyname(socket.gethostname())
# public_ip_address = requests.get('http://api.ipify.org') #get in text
# have public ip 
# myip.is 
...
# GUI 
window = tk.Tk()
window.title("MINSTONE Calls v0.0.1 Alpha ")
